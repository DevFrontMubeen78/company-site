                ...
                <div className="container">
                    <div className="main flex flex-col gap-18">
                        <div className="content text-center flex flex-col gap-3">
                            <h1 className="md:text-5xl sm:text-4xl text-2xl font-bold uppercase leading-snug text-[#fff]">Mobile App Development</h1>
                        ...
                        <div className="content text-center flex flex-col gap-3">
                            <h1 className="md:text-4xl sm:text-4xl text-2xl font-bold uppercase leading-snug text-[#fff]">Benefits of Our
                                <span className="text-[#FF0066] "> Mobile App Developers for Hire</span>
                            </h1>
                        ...
                        <div className="corporate">
                            <div className="content_corporate grid md:grid-cols-2 grid-cols-1 xl:gap-40 md:gap-20 gap-10">
                                <div className="flex flex-col gap-20">
                                    {
                                        mobileApp.corporate.map((items, index) => {
                                            return (
                                ...
                                <div className="flex flex-col gap-20">
                                    {
                                        mobileApp.corporate1.map((items, index) => {
                                            return (
                                                <div key={index} className="innertext flex flex-col gap-2">
                                                    <h6 className="font-bold text-2xl text-[#fff]">{items.title}</h6>
                                                    <p className="text-base text-[#fff]">{items.desc}</p>

                ...
                <div className="container">
                    <div className="main flex flex-col gap-18">
                        <div className="content text-center flex flex-col gap-3">
                            <h1 className="md:text-5xl sm:text-4xl text-2xl font-bold uppercase leading-snug text-[#000]">Mobile App Development</h1>
                        ...
                        <div className="corporate flex flex-col gap-16">
                            <div className="content text-center flex flex-col gap-5">
                                <h1 className="md:text-3xl text-2xl font-bold leading-snug text-[#000]">Benefits of Our
                                    <span className="text-[#827FE1]">  Mobile App Developers for Hire</span>
                                </h1>
                                <p className="md:text-lg text-base leading-normal text-center w-full heading_content text">Entrepreneurs looking to hire mobile app developers seek versatile professionals who can handle a range of tasks. The top-tier mobile app developers at DTechKrew go beyond basic coding, offering expertise in app design, development, performance optimization, cross-platform solutions, automation, and seamless integration.</p>
                            </div>
                            <div className="content_corporate grid md:grid-cols-2 grid-cols-1 xl:gap-40 md:gap-20 gap-10">
                                <div className="flex flex-col gap-20">
                                    {
                                        MobAPPDev.DScience.map((items, index) => {
                                            return (
                                ...
                                <div className="flex flex-col gap-20">
                                    {
                                        MobAPPDev.DScience1.map((items, index) => {
                                            return (
                                                <div key={index} className="innertext flex flex-col gap-2">
                                                    <h6 className="font-bold text-2xl text-[#000]">{items.title}</h6>
                                                    <p className="text-base text">{items.desc}</p>
